...
public interface EventTypes {
	...
	public static enum HierarchyEvents implements EventTypes {
		CHANGED("hierarchyChanged");
		private HierarchyEvents(String handlerName) {
			TypeMetadata.register(this, handlerName, HierarchyListener.class, HierarchyEvent.class);
		}
	}
	
	public static enum ComponentEvents implements EventTypes {
		RESIZED("componentResized"), MOVED("componentMoved"), SHOWN("componentShown"), HIDDEN("componentHidden");
		private ComponentEvents(String handlerName) {
			TypeMetadata.register(this, handlerName, ComponentListener.class, ComponentEvent.class);
		}
	}
